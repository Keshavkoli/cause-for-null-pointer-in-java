...
public class Employee {
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "houseNo", column = @Column(name = "Home_House_No")),
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "houseNo", column = @Column(name = "Office_House_No")),
	...
	//@JoinTable(name = "List_Address", joinColumns = @JoinColumn(name = "Emp_Id")) // To change id column name and table
																					// name
	// @GenericGenerator(name = "hilo-gen", strategy = "hilo") //Depricated
	// @GenericGenerator(name="sequence-gen",strategy="sequence")
	// @CollectionId(columns = { @Column(name="Address_Id") }, generator =
	// "sequence-gen", type = @Type(type ="long"))
